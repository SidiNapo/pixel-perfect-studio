...
const stats = [
  { value: 10, suffix: "M+", label: "Pages Analyzed" },
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {['Innovation First', 'Data-Driven', 'Client Success', 'Transparency'].map((value, index) => (
                <motion.span
                  key={value}
                  initial={{ opacity: 0, scale: 0.8 }}
                  whileInView={{ opacity: 1, scale: 1 }}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Industry veterans and brilliant innovators united by a passion for pushing the boundaries of SEO technology.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="relative rounded-2xl overflow-hidden bg-card border border-border hover:border-primary/50 transition-all duration-500 hover:shadow-[0_0_40px_rgba(139,92,246,0.15)]">
                  {/* Image */}
